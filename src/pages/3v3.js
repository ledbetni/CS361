...
function Threes({ setVendorToEdit }) {
    


    return(
        <div>
            <h1 className="title">3v3 Arena</h1>
            ...
            <p>This page will display information for 3v3 arena</p>


            <fieldset>
                <h2>3v3 Arena Leaderboards</h2>
                <div> This is the area in which Battle.net API 3v3 leaderboard information will be displayed.
